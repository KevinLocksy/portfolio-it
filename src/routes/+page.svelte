...
<div id="main-wrapper">
	<!-- wrapper if i want to make a component out of it: it is easier for the css, etc-->
				...
				{#each SOCIAL_MEDIA as { url, img, alt, title }}
					<div class="pres-desc-social-item">
						<a href={url} target="_blank">
							<img
								class="logo clickable socialMedia"
								src={$isDarkTheme ? img.dark : img.light}
								{alt}
								{title}
							/>
						</a>
		...
		<div id="techStack-wrapper">
			...
			<div id="techStack-list">
				{#each TECH_STACK as { name, img }}
					<div class="techStack-logo-container" {name}>
